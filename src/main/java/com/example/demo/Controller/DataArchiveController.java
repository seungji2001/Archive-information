...
//        return ResponseEntity.ok().body(dataArchiveService.searchData(searchData,googleKey,cx));
    ...
    @GetMapping("/nelinking")
    public ResponseEntity<List<NELinkingResponseDto.ResponseDto>> getNELinking() throws JsonProcessingException {
        ...
        return ResponseEntity.ok().body(neLinkingManager.getNeLinking(getKey, contents));
    }
}
